                          ...
                          <div className="flex flex-1 items-start gap-2 h-36 md:h-44">
                            ...
                            <div className="h-full flex flex-1 flex-col justify-between py-1">
                              ...
                              <div className="flex items-center gap-2">
                                <TooltipProvider>
                                  {/* Fix 1: ProductSideMenu - ensure it doesn't render a button */}
                                  <Tooltip>
                                  ...
                                  {/* Fix 2: Delete button - ensure proper button structure */}
                                  <Tooltip>
                                    <TooltipTrigger asChild>
                                      <button
                                        onClick={() => {
                                      ...
                                      >
                                        <Trash className="w-4 h-4 md:w-5 md:h-5 text-gray-500 hover:text-red-600 hoverEffect" />
                                      </button>
                                    </TooltipTrigger>
                    ...
                    {addresses && (
                      <div className="bg-white rounded-md mt-5">
                        <Card>
                          ...
                          <CardContent>
                            {/* Fix 3: Address selection - ensure no button nesting */}
                            <RadioGroup
